...
/*		 
 * Copyright (C) 2007-2015 Paolo Boldi, Massimo Santini and Sebastiano Vigna 
 *
...
public class CompressedIntLabel extends AbstractIntLabel implements Serializable {
	...
	private static LongBigList loadLabels( File nodeLabels, int nodeWidth ) throws IOException {
		final InputBitStream ibs = new InputBitStream( nodeLabels );
		int n = (int)( ( nodeLabels.length() * Byte.SIZE ) / nodeWidth );
	...
	public CompressedIntLabel( Object directory, String key, String value, String labels, String nodeWidth, String decoders, String coders ) throws NumberFormatException, FileNotFoundException, IOException, ClassNotFoundException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public CompressedIntLabel( Object directory, String key, String value, String labels, String nodeWidth, String decoders ) throws NumberFormatException, FileNotFoundException, IOException, ClassNotFoundException {
		this( key, Integer.parseInt( value ), loadLabels( new File( (File)directory, labels ), Integer.parseInt( nodeWidth ) ),
	...
	@Override
	public int fromBitStream(InputBitStream inputBitStream, long source)
	...
	@Override
	public int toBitStream(OutputBitStream outputBitStream, long source)
			throws IOException, UnsupportedOperationException {
		// TODO Auto-generated method stub
		return 0;
	}
